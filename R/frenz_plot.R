...
#' @param accuracy_df accuracy score dataframe that is return after \link[Rfrenz:sget_accuracy]{get_accuracy()}from Rfrenze is run. The accruacy_df is used to plot a boxplot summarising the data
